...
def test_ReMoNet(**args):
	...
	model_temp = ReMoNet(num_input_frames=NUM_IN_FR_EXT, num_output_frames=NUM_OUT_FR)
...
if __name__ == "__main__":
	...
	parser.add_argument("--model_file", type=str,\
						default="./logs/logs_ReMoNet_lr8e-5_E60/net.pth", \
						help='path to model of the pretrained denoiser')
	parser.add_argument("--test_path", type=str, default="./data/DAVIS_test/planes-crossing/", \
						help='path to sequence to denoise')
	parser.add_argument("--suffix", type=str, default="", help='suffix to add to output name')
	parser.add_argument("--max_num_fr_per_seq", type=int, default=30, \
	...
	parser.add_argument("--save_path", type=str, default='./test_results_test', \
